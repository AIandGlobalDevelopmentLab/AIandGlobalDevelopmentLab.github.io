...
layout: default
title: FAQ
description: Frequently asked questions about the AI & Global Development Lab.
---

<div class="page-header">
  <div class="container">
    <h1>Frequently Asked Questions</h1>
    <p class="page-description">Common questions about our research, data, tools, and opportunities.</p>
  </div>
</div>
  ...
  <div class="container container-narrow">
    ...
    <div class="accordion mb-6">
      <div class="accordion-item">
        <button class="accordion-header">What is the AI & Global Development Lab?</button>
      ...
      <div class="accordion-item">
        <button class="accordion-header">What makes your approach different?</button>
        <div class="accordion-content">
          <div class="accordion-body">
      ...
      <div class="accordion-item">
        <button class="accordion-header">What time period does your data cover?</button>
        <div class="accordion-content">
          <div class="accordion-body">
    ...
    <div class="accordion mb-6">
      <div class="accordion-item">
        <button class="accordion-header">Can I use your datasets for my research?</button>
        <div class="accordion-content">
          <div class="accordion-body">
      ...
      <div class="accordion-item">
        <button class="accordion-header">How do I cite your software?</button>
        <div class="accordion-content">
          <div class="accordion-body">
      ...
      <div class="accordion-item">
        <button class="accordion-header">Do you offer technical support for your tools?</button>
        <div class="accordion-content">
          <div class="accordion-body">
    ...
    <div class="accordion mb-6">
      <div class="accordion-item">
        <button class="accordion-header">How can I collaborate with the lab?</button>
        <div class="accordion-content">
          <div class="accordion-body">
      ...
      <div class="accordion-item">
        <button class="accordion-header">Do you work with policy organizations?</button>
        <div class="accordion-content">
          <div class="accordion-body">
    ...
    <div class="accordion mb-6">
      <div class="accordion-item">
        <button class="accordion-header">How do I apply to be a PhD student?</button>
        <div class="accordion-content">
          <div class="accordion-body">
      ...
      <div class="accordion-item">
        <button class="accordion-header">What background do you look for in applicants?</button>
        <div class="accordion-content">
          <div class="accordion-body">
      ...
      <div class="accordion-item">
        <button class="accordion-header">Do you hire research assistants?</button>
        <div class="accordion-content">
          <div class="accordion-body">
