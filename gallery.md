...
<section class="section section-gray">
  <div class="container container-narrow text-center">
    <h2>Use Our Images</h2>
    <p>Images from our research are available for academic and educational use with attribution. For high-resolution versions or media inquiries, please <a href="{{ '/contact/' | relative_url }}">contact us</a>.</p>
  </div>
</section>
