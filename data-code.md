...
<div class="page-header page-header-left">
  <div class="container">
    <h1>Data & Code</h1>
    <p class="page-description">We release open-source software and datasets to enable reproducible research. All tools are freely available for academic use.</p>
  </div>
</div>
